...
const drawEllipse = function (ctx, rx, ry, cx, cy) {
  if (cx === void 0) {
    cx = 0;
  }
  if (cy === void 0) {
...
const parseCommonFormOptions = node => {
  ...
  return {
    ...
    value: ((_node$props4 = node.props) === null || _node$props4 === void 0 ? void 0 : _node$props4.value) || undefined,
    defaultValue: ((_node$props5 = node.props) === null || _node$props5 === void 0 ? void 0 : _node$props5.defaultValue) || undefined
  };
};
const parseTextFieldOptions = (node, fieldSet) => {
  ...
  return clean({
    ...
    multiline: ((_node$props7 = node.props) === null || _node$props7 === void 0 ? void 0 : _node$props7.multiline) || undefined,
    ...
    format: ((_node$props10 = node.props) === null || _node$props10 === void 0 ? void 0 : _node$props10.format) || undefined,
    fontSize: ((_node$props11 = node.props) === null || _node$props11 === void 0 ? void 0 : _node$props11.fontSize) || undefined,
    MaxLen: ((_node$props12 = node.props) === null || _node$props12 === void 0 ? void 0 : _node$props12.maxLength) || undefined
  });
};
...
const parseCheckboxOptions = (ctx, node, fieldSet) => {
  ...
  normalAppearance[onOption] = getAppearance(ctx, xMark ? '8' : '4', width, height);
  normalAppearance[offOption] = getAppearance(ctx, xMark ? ' ' : '8', width, height);
  return clean({
    ...parseCommonFormOptions(node),
    backgroundColor: ((_node$props21 = node.props) === null || _node$props21 === void 0 ? void 0 : _node$props21.backgroundColor) || undefined,
    borderColor: ((_node$props22 = node.props) === null || _node$props22 === void 0 ? void 0 : _node$props22.borderColor) || undefined,
    parent: fieldSet || undefined,
...
const renderTextInput = function (ctx, node, options) {
  ...
  ctx.formText(name, left, top, width, height, parseTextFieldOptions(node, fieldSetOptions));
};
...
const renderFieldSet = function (ctx, node, options) {
  var _node$props;
  if (options === void 0) {
    options = {};
  }
...
const renderCheckbox = function (ctx, node, options) {
  var _node$props, _options$fieldSets;
  if (options === void 0) {
    options = {};
  }
